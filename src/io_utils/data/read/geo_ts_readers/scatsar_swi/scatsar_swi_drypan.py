...
from io_utils.data.read.geo_ts_readers.scatsar_swi.base_reader import ScatSarSWIDrypanReader
import numpy as np
from collections import OrderedDict
from geopathfinder.file_naming import SmartFilename
try:
    from io_utils.data.path_configs.scatsar.paths_scatsar_drypan import path_settings
except ImportError:
    path_settings = {}
import copy
