...
import numpy as np
try:
    from io_utils.data.path_configs.esa_cci_sm.paths_esa_cci_sm_v04 import path_settings
    from io_utils.data.path_configs.esa_cci_sm.paths_esa_cci_sm_v04_ADJUSTMENT import \
